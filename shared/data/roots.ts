...
export const ROOT_FAMILIES: RootFamily[] = [
  ...
  { latin: "tenere", ko: "붙들다", members: ["contain", "retain", "obtain", "sustain", "maintain"] },
  {
    latin: "ferre",
    ko: "나르다",
    members: ["confer", "infer", "differ", "suffer", "transfer", "refer", "offer"],
  },
  ...
  { latin: "trahere", ko: "끌다", members: ["attract", "contract", "extract", "distract", "treat", "train"] },
  { latin: "scribere", ko: "쓰다", members: ["describe", "prescribe", "subscribe", "inscribe"] },
  { latin: "portare", ko: "나르다", members: ["export", "import", "report", "transport", "support"] },
  ...
  { latin: "ducere", ko: "이끌다", members: ["induce", "deduce", "introduce", "reduce", "conduct", "produce"] },
